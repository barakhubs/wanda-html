    ...
    <div class="admin-content">
        ...
        <div class="admin-card">
            ...
            <div style="display:flex;gap:.75rem;flex-wrap:wrap;">
                ...
                <a href="<?= BASE_URL ?>/admin/portfolio/create" class="btn-adm btn-adm-success">
                    <i class="bi bi-plus-lg"></i> New Portfolio Item
                </a>
                <a href="<?= BASE_URL ?>/admin/team/create" class="btn-adm btn-adm-outline">
                    <i class="bi bi-plus-lg"></i> Add Team Member
                </a>
                <a href="<?= BASE_URL ?>/admin/gallery/create" class="btn-adm btn-adm-outline">
        ...
        <div class="admin-card">
            ...
            <?php if (empty($recentPosts)) : ?>
                <p style="color:var(--admin-muted);font-size:.9rem">No blog posts yet.
                    <a href="<?= BASE_URL ?>/admin/blog/create">Create one now.</a>
                </p>
            <?php else : ?>
                        ...
                        <tbody>
                            <?php foreach ($recentPosts as $post) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= BASE_URL ?>/admin/blog/edit/<?= $post['id'] ?>" class="btn-adm btn-adm-outline btn-adm-sm"><i class="bi bi-pencil"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
