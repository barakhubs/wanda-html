...
/**
 * TeamMember model (includes team_skills child rows)
 */
class TeamMember
{
    private PDO $db;
    ...
    /** Returns all published members, each with a 'skills' sub-array */
    public function getAll(): array
    {
        ...
        return $this->attachSkills($members);
    }

    /** All members including unpublished (admin) */
    ...
    /**
     * Create a member and their skills.
     * @param array $data   Keys match column names; plus 'skills' => ['skill1', ...]
    ...
    public function create(array $data): int
    {
        ...
        $stmt->execute([
            ...
            'gradient_css'  => $data['gradient_css'] ?? 'linear-gradient(160deg,#1CB8D6,#1B2A6B)',
    ...
    {
        // team_skills cascade-deleted by FK
