...
// Create table if it doesn't exist yet (graceful upgrade for existing installs)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Collect all text/select fields
    $data = [
        // General
    ...
    // SMTP password: only update if a new value was supplied
...
.field-note .ok   { color: var(--admin-success); }
</style>
CSS;
...
(function () {
  ...
  function activateTab(target) {
    ...
    try { sessionStorage.setItem('settingsTab', target); } catch(e) {}
  }
  ...
  document.querySelectorAll('input[type="file"]').forEach(function (input) {
    input.addEventListener('change', function () {
      ...
      let   preview  = wrap.querySelector('.logo-preview');
      const isDark   = (input.id === 'footer_logo');
      ...
      reader.onload = function (ev) {
        if (preview) {
          ...
          preview.className = 'logo-preview' + (isDark ? ' logo-preview-dark' : '');
          preview.alt       = 'Preview';
...
<div class="admin-main">
    ...
    <div class="admin-content">
        ...
        <form id="settingsForm" method="post" enctype="multipart/form-data" action="" class="admin-form">
            <?= csrfField() ?>
                ...
                <div class="admin-card">
                    ...
                    <div class="form-row col-2">
                        ...
                        <div class="form-group">
                            ...
                            <span class="form-hint">Short descriptor shown in hero sections and meta descriptions.</span>
                        </div>
      ...
      ════════════════════════════════════════════════════════════ -->
            <div class="settings-panel" id="tab-email">
                    ...
                    <div class="form-row col-2">
                        <div class="form-group">
                            ...
                            <span class="form-hint">
                                Messages submitted via the contact form will be sent to this address.
                                Update contact.php to use this value when switching away from FormSubmit.co.
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="admin-card">
                    ...
                    <p style="font-size:.85rem;color:var(--admin-muted);margin-bottom:1.25rem">
                        Configure SMTP for direct PHP mail sending (e.g. with PHPMailer).
                        These values are stored and can be read via <code>setting('smtp_host')</code> etc.
                    </p>
                    ...
                    <div class="form-row col-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="smtp_from_email" name="smtp_from_email"
                                ...
                                placeholder="noreply@wandacommunications.ug">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <span class="field-note">
                                <?php if (!empty($s['smtp_password'])) : ?>
                                    <i class="bi bi-check-circle-fill ok"></i> Password saved. Leave blank to keep the current password.
                                <?php else : ?>
                                    <i class="bi bi-exclamation-circle"></i> No password saved yet.
                                <?php endif; ?>
                            </span>
                        </div>
                    </div>
