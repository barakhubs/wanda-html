...
<div class="admin-main">
    <div class="admin-topbar">
        <h1><i class="bi bi-pencil"></i> Edit Testimonial</h1>
    ...
    <div class="admin-content">
        ...
        <form method="post" class="admin-form">
            ...
            <div class="admin-card">
                ...
                <div class="form-row col-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="author_initials" name="author_initials" value="<?= e($data['author_initials']) ?>">
                    </div>
                    <div class="form-group">
                        <label for="author_role">Author Role</label>
                        <input type="text" id="author_role" name="author_role" value="<?= e($data['author_role']) ?>">
                    </div>
                    <div class="form-group">
                        <label for="author_org">Organisation</label>
                        <input type="text" id="author_org" name="author_org" value="<?= e($data['author_org']) ?>">
                    </div>
                </div>
            ...
            <button type="submit" class="btn-adm btn-adm-primary btn-adm-lg"><i class="bi bi-save"></i> Update</button>
        </form>
    </div>
</div>
