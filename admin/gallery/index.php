...
<div class="admin-main">
    <div class="admin-topbar">
        ...
        <div class="admin-topbar-actions">
            <a href="<?= BASE_URL ?>/admin/gallery/create.php" class="btn-adm btn-adm-primary">
    ...
    <div class="admin-content">
        ...
        <div class="admin-card">
            ...
            <?php if (empty($images)) : ?>
                <p style="color:var(--admin-muted)">No gallery images yet. <a href="<?= BASE_URL ?>/admin/gallery/create.php">Upload one.</a></p>
            <?php else : ?>
                    ...
                    <?php foreach ($images as $img) : ?>
                        <div class="admin-gallery-item">
                            ...
                            <?php if (!$img['published']) : ?>
                                <span class="badge badge-muted" style="position:absolute;top:6px;left:6px;font-size:.65rem">Hidden</span>
                            <?php endif; ?>
                            <form method="post" action="<?= BASE_URL ?>/admin/gallery/delete.php" class="gallery-delete"
