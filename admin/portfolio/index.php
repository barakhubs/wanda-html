...
<div class="admin-main">
    <div class="admin-topbar">
        ...
        <div class="admin-topbar-actions">
            <a href="<?= BASE_URL ?>/admin/portfolio/create.php" class="btn-adm btn-adm-primary">
    ...
    <div class="admin-content">
        ...
        <div class="admin-card">
            ...
            <?php if (empty($items)) : ?>
                <p style="color:var(--admin-muted)">No portfolio items yet. <a href="<?= BASE_URL ?>/admin/portfolio/create.php">Add one.</a></p>
            <?php else : ?>
                            ...
                            <?php foreach ($items as $item) : ?>
                                <tr>
                                    ...
                                    <td style="white-space:nowrap">
                                        <a href="<?= BASE_URL ?>/admin/portfolio/edit.php?id=<?= $item['id'] ?>" class="btn-adm btn-adm-outline btn-adm-sm"><i class="bi bi-pencil"></i></a>
                                        <form method="post" action="<?= BASE_URL ?>/admin/portfolio/delete.php" style="display:inline"
