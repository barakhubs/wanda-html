...
<div class="admin-main">
    <div class="admin-topbar">
        ...
        <div class="admin-topbar-actions">
            <a href="<?= BASE_URL ?>/admin/team/create.php" class="btn-adm btn-adm-primary">
    ...
    <div class="admin-content">
        ...
        <div class="admin-card">
            ...
            <?php if (empty($members)) : ?>
                <p style="color:var(--admin-muted)">No team members yet. <a href="<?= BASE_URL ?>/admin/team/create.php">Add one.</a></p>
            <?php else : ?>
                            ...
                            <?php foreach ($members as $m) : ?>
                                <tr>
                                    ...
                                    <td style="white-space:nowrap">
                                        <a href="<?= BASE_URL ?>/admin/team/edit.php?id=<?= $m['id'] ?>" class="btn-adm btn-adm-outline btn-adm-sm"><i class="bi bi-pencil"></i></a>
                                        <form method="post" action="<?= BASE_URL ?>/admin/team/delete.php" style="display:inline"
