...
<div class="admin-main">
    <div class="admin-topbar">
        <h1><i class="bi bi-pencil"></i> Edit Team Member</h1>
            ...
            <div class="admin-card">
                ...
                <?php if ($data['photo']) : ?>
                    <div class="img-preview" style="margin-bottom:.75rem">
                        <img src="<?= e(BASE_URL . '/' . $data['photo']) ?>" alt="" style="border-radius:50%;width:80px;height:80px;object-fit:cover">
                        <span class="form-hint" style="display:block;margin-top:.3rem">Upload a new one to replace.</span>
                    </div>
                <?php endif; ?>
            ...
            <div class="admin-card">
                ...
                <div class="form-row col-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="fallback_icon" name="fallback_icon" value="<?= e($data['fallback_icon']) ?>">
                    </div>
                </div>
