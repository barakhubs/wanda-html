...
<div class="admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="admin-card">
            ...
            <?php if (empty($posts)) : ?>
                <p style="color:var(--admin-muted)">No blog posts yet. <a href="<?= BASE_URL ?>/admin/blog/create.php">Create one.</a></p>
            <?php else : ?>
                            ...
                            <?php foreach ($posts as $post) : ?>
                                <tr>
                                    ...
                                    <td style="white-space:nowrap">
                                        ...
                                        <a href="<?= BASE_URL ?>/admin/blog/edit.php?id=<?= $post['id'] ?>" class="btn-adm btn-adm-outline btn-adm-sm" title="Edit">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form method="post" action="<?= BASE_URL ?>/admin/blog/delete.php" style="display:inline"
