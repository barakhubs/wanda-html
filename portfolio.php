...
$pageDesc     = 'Photography, videography, advocacy campaigns, and strategic communication projects by Wanda Communications Uganda.';
$currentPage  = 'portfolio';
$extraScripts = '<script src="' . BASE_URL . '/js/gallery.js"></script>';

$portfolioModel = new Portfolio();
$items          = $portfolioModel->getPublished();
...
<!-- LIGHTBOX (gallery.js fills these fields from data attributes) -->
